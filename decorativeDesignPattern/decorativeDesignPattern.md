      ...
      <html>
        <head>
            <meta charset="utf-8" />
            <title>decorativeDesignPattern</title>
...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  color: #d19a66;
        ...
        <body class='markdown-preview' data-use-github-style><h1 id="装饰设计模式">装饰设计模式</h1>
<ul>
<li><p>定义：指在不改变现有对象结构的情况下，动态地给该对象增加一些职责（即增加其额外功能）的模式，它属于对象结构型模式。</p>
</li>
<li><p>装饰设计模式的优点：</p>
<ol>
...
<li><p>其主要缺点是：装饰模式增加了许多子类，如果过度使用会使程序变得很复杂。</p>
</li>
</ul>
<h2 id="装饰设计模式的结构">装饰设计模式的结构</h2></body>
      </html>
